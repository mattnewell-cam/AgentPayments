...
def hmac_sign(data: str, secret: str) -> str:
    """HMAC-SHA256 sign data with secret, return lowercase hex digest."""
...
def generate_agent_key(secret: str) -> str:
    """Generate an agent key: ag_{16-char-random}_{16-char-hmac}."""
...
def is_valid_agent_key(key: str, secret: str) -> bool:
    """Validate an agent key by checking its HMAC signature."""
